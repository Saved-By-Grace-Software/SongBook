...
public class CurrentSetItemViewHolder extends RecyclerView.ViewHolder implements MenuItem.OnMenuItemClickListener,
    ...
    public CurrentSetItemViewHolder(View v, final MainActivity mainActivity) {
        ...
        mPopupMenu = new PopupMenu(mMainActivity, v);
        registerPopupMenu(mPopupMenu);
