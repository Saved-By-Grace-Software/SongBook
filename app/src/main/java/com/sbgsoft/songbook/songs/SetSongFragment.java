...
public class SetSongFragment extends Fragment {
	...
	public void onTransposeButtonClick() {
    	...
    	if (!StaticVars.songKeys.contains(mSongItem.getKey())) {
            Snackbar.make(mView, "You cannot transpose a song without an legit assigned key. Please edit the song attributes, edit the key, and try again.", Snackbar.LENGTH_LONG).show();
    	}
    	else {
        	...
        	alert.setItems(keys, new OnClickListener() {
        		public void onClick (DialogInterface dialog, int whichItem) {
					...
					try {
                        ...
                        Snackbar.make(mView, "Could not open song file!", Snackbar.LENGTH_LONG).show();
						return;
					} catch (IOException e) {
                        Snackbar.make(mView, "Could not open song file!", Snackbar.LENGTH_LONG).show();
						return;
