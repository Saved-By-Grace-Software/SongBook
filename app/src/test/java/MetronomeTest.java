...
public class MetronomeTest {
    ...
    @Test
    public void testCalculateBPMFromTickDelay() {
        // Test setup
        Metronome mTest = new Metronome();
        HashMap testValues = new HashMap();     // Key = BPM, Value = Delay
        TimeSignature tSig = new TimeSignature("4/4");
        ...
        while (it.hasNext()) {
            ...
            int calcBPM = mTest.calculateBPMFromTickDelay((int) pair.getValue(), tSig);
            assertEquals("Failed to calculate BPM correctly for " + pair.getValue() + " tick time", (int) pair.getKey(), calcBPM);
        }
